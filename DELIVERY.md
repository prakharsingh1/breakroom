...
Passing cases establish behavior only under modeled conditions. Provider equivalence, universal safety, statistical model performance, production readiness, trademark/domain/package ownership and a public license are not claimed. Review [the license proposal](LICENSE-PROPOSAL.md) and [security scope](SECURITY.md) before publication.
